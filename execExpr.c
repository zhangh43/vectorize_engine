 ...
 */
ExprState *
VExecInitExprWithParams(Expr *node, ParamListInfo ext_params)
{
	ExprState  *state;
	ExprEvalStep scratch = {0};
 ...
 */
ExprState *
VExecInitQual(List *qual, PlanState *parent)
{
	ExprState  *state;
	ExprEvalStep scratch = {0};
 ...
 */
ExprState *
VExecInitCheck(List *qual, PlanState *parent)
{
 ...
 */
List *
VExecInitExprList(List *nodes, PlanState *parent)
{
	List	   *result = NIL;
	ListCell   *lc;
 ...
 */
ProjectionInfo *
VExecBuildProjectionInfo(List *targetList,
 ...
 */
ExprState *
VExecPrepareExpr(Expr *node, EState *estate)
{
	ExprState  *result;
 ...
 */
ExprState *
VExecPrepareQual(List *qual, EState *estate)
{
	ExprState  *result;
	MemoryContext oldcontext;
 ...
 */
ExprState *
VExecPrepareCheck(List *qual, EState *estate)
{
	ExprState  *result;
	MemoryContext oldcontext;
 ...
 */
List *
VExecPrepareExprList(List *nodes, EState *estate)
{
	List	   *result = NIL;
	MemoryContext oldcontext;
	ListCell   *lc;
...
ExecReadyExpr(ExprState *state)
{
	...
	VectorExecReadyInterpretedExpr(state);
}
 ...
 */
ExprState *
VExecBuildAggTrans(AggState *aggstate, AggStatePerPhase phase,
 ...
 */
ExprState *
VExecBuildGroupingEqual(TupleDesc ldesc, TupleDesc rdesc,
