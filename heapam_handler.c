...
static const TableAmRoutine vector_heapam_methods;
...
vector_heapam_slot_callbacks(Relation relation)
{
	return &TTSOpsVectorBufferHeapTuple;
}
...
static const TableAmRoutine vector_heapam_methods = {
	...
	.slot_callbacks = vector_heapam_slot_callbacks,

	.scan_begin = vector_heap_beginscan,
	.scan_end = vector_heap_endscan,
	.scan_rescan = vector_heap_rescan,
	.scan_getnextslot = vector_heap_getnextslot,
...
VGetHeapamTableAmRoutine(void)
{
	return &vector_heapam_methods;
}
